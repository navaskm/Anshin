...
const WhatsApp = () => {
  return (
    ...
    >
      <img src="whatsapp.png" alt="Chat on WhatsApp" className='fixed bottom-0 right-0 z-50 cursor-pointer w-10 h-10 rounded-2xl md:bottom-5 md:right-5 md:w-20 md:h-20'/>
    </a>
  )
}
